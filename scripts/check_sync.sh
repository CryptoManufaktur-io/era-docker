...
Options:
  ...
  --local-rpc URL          Local RPC URL (default: http://127.0.0.1:${RPC_PORT:-3060})
...
Examples:
  ./check_sync.sh --public-rpc https://mainnet.era.zksync.io
  ./check_sync.sh --compose-service era-node --public-rpc https://mainnet.era.zksync.io
  CONTAINER=era-node-1 PUBLIC_RPC=https://mainnet.era.zksync.io ./check_sync.sh
EOF
}
